...
public class LinkService extends MenuService {
	...
	public void traitement() {
		...
		console.html("<table>"
				...
				+ "<tr><td><a class='btn-blue' href='linkService.modifier(23)'>Modifier</a></td><td><a class='btn-red' href='linkService.supprimer(23)'>Supprimer</a></td><td>Véhicule CV-HR-123</td></tr>"
				+ "</table>");
